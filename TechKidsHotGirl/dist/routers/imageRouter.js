...
imageRouter.get("/", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var images, err_1;
...
imageRouter.get("/:id", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var id, image, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, imageController_1.getImageById(id)];
            case 1:
                image = _a.sent();
...
imageRouter.post("/", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, imageController_1.addImage(body)];
            case 2:
                image = _a.sent();
                res.status(200).send(image);
                return [3 /*break*/, 4];
