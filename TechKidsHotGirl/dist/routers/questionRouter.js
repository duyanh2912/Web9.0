...
router.get("/", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, questionApi.randomQuestion()];
            case 1:
                question = _a.sent();
            ...
            case 2:
                err_1 = _a.sent();
                renderErrorPage_1.default(res, err_1);
                return [3 /*break*/, 3];
...
router.get("/:id", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var question, yesPercent, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, questionApi.getQuestion(req.params.id)];
            case 1:
                question = _a.sent();
                yesPercent = question.yes / (question.yes + question.no) * 100;
            ...
            case 2:
                err_2 = _a.sent();
                renderErrorPage_1.default(res, err_2);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                res.send("<p>UserModel: " + content + "</p> <p>Likes: " + likes + "</p>");
                return [2 /*return*/];
