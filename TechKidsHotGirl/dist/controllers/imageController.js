...
// Create Image
exports.addImage = function (image) { return __awaiter(_this, void 0, void 0, function () {
    var user, controlledImage, imageDoc;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, userController_1.getUserById(image.poster)];
            case 1:
                user = _a.sent();
                if (!user) {
                ...
                imageDoc = new imageModel_1.default(controlledImage);
                return [2 /*return*/, imageDoc.save()];
        }
    });
}); };
// Get All Image
...
// Like increment
exports.increaseImageLikes = function (imageId, userId) { return __awaiter(_this, void 0, void 0, function () {
    var user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, userController_1.getUserById(userId)];
            case 1:
                user = _a.sent();
                if (!user) {
                    throw new Error("Invalid poster id.");
