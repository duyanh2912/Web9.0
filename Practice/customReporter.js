...
let myCustomReporter = {
    jasmineStarted: function(suiteInfo) {
        console.log(style.yellow('Running suite with ' + suiteInfo.totalSpecsDefined));
        console.log(style.yellow('Reporting via MyCustomReporter'));
    },
    ...
    specDone: function(result) {
        if (result.status === "passed") {
          ...
          process.stdout.write(style.green(`${specPass} case has been passed`));
        } else {
