...
// Add new user
exports.addUser = function (user) { return __awaiter(_this, void 0, void 0, function () {
    var hash, newUser;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, new userModel_1.default(newUser).save()];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
...
exports.getAllUsers = function () {
    return userModel_1.default.find({}).select("-password").exec();
};
// Get user by id
